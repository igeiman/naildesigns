#################################
# This function is used to override DynamoDB to ES streaming function
# Amplify keeps overriding my changes with deafult streaming so i needed to override manually
# The below permissions should be added to Lambda to allow the use of comprehend
...
def _lambda_handler(event, context):
    ...
    for record in records:
        ...
        # Add sentiment analisys to payload when comment added to DynamoDB comment table
        sentiment = {}
